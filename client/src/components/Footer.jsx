...
function Footer() {
	return (
		<div className="footer bg-[#1E2833] text-white mb-0 w-screen pt-16">
			<div className='px-5 flex flex-col w-screen md:items-center'>
				<h1 className="text-5xl md:text-6xl">Black Market</h1>
				<p className="text-[#81868C] text-center w-64 my-3 md:text-xl md:w-96">We are a Reputed Men’s Clothing
				...
				<div className="footer-links font-medium flex w-44 my-8 md:text-xl justify-center">
