  ...
  return (
    <div className="add_cart my-2 flex flex-col gap-5 mx-2 lg:mt-4">
      ...
      <div className="buttons flex flex-row gap-2">
        {" "}
        <button className="cartButton flex sm:px-12 sm:py-3 w-[150px] sm:w-auto text-xs sm:text-lg items-center justify-center sm:font-semibold gap-3 bg-PrimaryBlue text-white rounded-3xl ">
          <BsHandbag />
          Add To Cart
        </button>
